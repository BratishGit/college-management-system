                    ...
                    {exams.map((exam, i) => (
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-bold text-surface-900 mb-1">{exam.subject?.name}</h3>
                                    <p className="text-xs font-black text-primary-600 tracking-[0.2em]">{exam.subject?.code}</p>
                                </div>
